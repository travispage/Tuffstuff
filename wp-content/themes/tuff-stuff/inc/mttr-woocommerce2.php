...
function mttr_woocommerce_before_shop_loop() {
	...
	echo '<h2 class="display-heading  display-heading--beta  u-flush--bottom">' . esc_html( $title ) . '</h2>';
				...
				echo '<li class="listing__item">';
					...
					echo '<div class="facet-filter">';
						...
						echo '<div class="facet-filter__content">';
							...
							echo '<h4 class="display-heading  display-heading--small  u-flush--bottom">Narrow Results</h4>';
...
function woocommerce_product_loop_start( $echo = true ) {
	...
	*/
	...
	// function mttr_read_more_button() {

	// 	echo '<a class="btn  btn--secondary  btn--fill" href="' . get_the_permalink() . '">Read More</a>';

	// }

	// add_action( 'woocommerce_after_shop_loop_item', 'mttr_read_more_button', 12 );
