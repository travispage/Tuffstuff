		...
		*/
		if ( get_row_layout() == 'map' ) {
			...
			if ( !wp_script_is( 'google-maps', 'enqueued' ) ) {
				...
				wp_register_script( 'google-maps', '//maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&key=AIzaSyABsEwHxjZAJWxxd5RaVN8TCULK109LrDg', array( 'jquery' ), NULL, true );
